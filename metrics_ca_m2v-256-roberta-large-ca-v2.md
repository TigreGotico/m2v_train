...
## catalan - Model: Jarbas/m2v-256-roberta-large-ca-v2
### Accuracy: 0.996995117065231
### F1 Score: 0.9963977278240932
### Cohen Kappa Score: 0.9963287277912192
### Matthews Corrcoef Score: 0.9963296071077593
...
```
         ...
         ovos-skill-audio-recording.openvoiceos:start_recording.intent       0.98      1.00      0.99        57
...
ovos-skill-boot-finished.openvoiceos:disable_ready_notification.intent       1.00      1.00      1.00      2048
 ovos-skill-boot-finished.openvoiceos:enable_ready_notification.intent       1.00      1.00      1.00      2458
                      ovos-skill-camera.openvoiceos:have_camera.intent       0.00      0.00      0.00         1
           ...
           ovos-skill-date-time.openvoiceos:date.future.weekend.intent       1.00      1.00      1.00       117
             ovos-skill-date-time.openvoiceos:date.last.weekend.intent       1.00      1.00      1.00       519
              ...
              ovos-skill-date-time.openvoiceos:what.month.is.it.intent       1.00      1.00      1.00         5
               ovos-skill-date-time.openvoiceos:what.time.is.it.intent       0.98      1.00      0.99        92
       ...
       ovos-skill-days-in-history.openvoiceos:deaths_in_history.intent       0.00      0.00      0.00         1
        ovos-skill-days-in-history.openvoiceos:today_in_history.intent       1.00      1.00      1.00       217
           ...
           ovos-skill-diagnostics.openvoiceos:query_extra_langs.intent       1.00      0.91      0.95        34
        ...
        ovos-skill-diagnostics.openvoiceos:query_kernel_version.intent       1.00      1.00      1.00         7
                 ovos-skill-diagnostics.openvoiceos:query_langs.intent       0.97      1.00      0.99       145
         ...
         ovos-skill-diagnostics.openvoiceos:query_user_location.intent       1.00      0.95      0.97        19
               ovos-skill-dictation.openvoiceos:start_dictation.intent       1.00      0.99      0.99        93
                ovos-skill-dictation.openvoiceos:stop_dictation.intent       1.00      1.00      1.00        25
             ovos-skill-fuster-quotes.openvoiceos:fuster_quotes.intent       0.71      1.00      0.83         5
                       ovos-skill-fuster-quotes.openvoiceos:who.intent       0.00      0.00      0.00         2
                   ovos-skill-hello-world.openvoiceos:Greetings.intent       0.80      0.80      0.80         5
             ...
             ovos-skill-icanhazdadjokes.openvoiceos:search_joke.intent       1.00      1.00      1.00        15
                  ...
                  ovos-skill-iss-location.openvoiceos:where_iss.intent       1.00      1.00      1.00        53
                       ...
                       ovos-skill-laugh.openvoiceos:RandomLaugh.intent       1.00      1.00      1.00         5
                        ...
                        ovos-skill-news.openvoiceos:global_news.intent       1.00      0.91      0.95        11
                               ovos-skill-news.openvoiceos:news.intent       0.99      1.00      0.99        77
                  ovos-skill-parrot.openvoiceos:did.you.hear.me.intent       0.00      0.00      0.00         2
                     ...
                     ovos-skill-parrot.openvoiceos:start_parrot.intent       0.67      0.40      0.50         5
                      ovos-skill-parrot.openvoiceos:stop_parrot.intent       0.79      1.00      0.88        11
